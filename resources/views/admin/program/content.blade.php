            ...
            <span class="position-absolute top-0 start-100 translate-middle p-2 border border-light rounded-circle"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item"
                            href="{{ route('admin.content.delete', ['id' => $content->id, 'topicId' => $content->topic_id]) }}"
                            onclick="return confirm('Are you sure, delete this content?')">Delete</a></li>
                </ul>
            </span>
            ...
            @elseif ($content->content_type == 'video')
                <div class="col text-center">
                    <video class="img-fluid" controls style="max-width: 100%;">
                        <source src="{{ asset('storage/course/topic/content/' . $content->content_path) }}"
                            type="video/mp4">
            ...
            @elseif ($content->content_type == 'image')
                <div class="col text-center">
                    <img src="{{ asset('storage/course/topic/content/' . $content->content_path) }}" alt=""
                        class="img-fluid" style="max-height: 420px; max-width: 100%;">
                </div>
            @else
                <div class="col text-center">
