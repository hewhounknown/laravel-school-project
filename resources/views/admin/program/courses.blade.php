                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mt-2">
                                    <label for="image">
                                        <img id="img" src="{{ asset('img/add_image.png') }}" alt="profile picture"
                    ...
                    <div class="card  my-1" style="height: 120px">
                        <div class="row bg-warning-subtle text-emphasis-warning g-0">
                            <div class="col-3">
                                @if ($new->course_image == null)
                                    <img src="{{ asset('img/default.png') }}" class="img-fluid"
                                        style="width: 170px; height: 120px" alt="">
                                @else
                                    <img src="{{ asset('storage/course/' . $new->course_image) }}" class="img-fluid"
                                        style="width: 170px; height: 120px" alt="">
                                @endif
                            </div>
                            <div class="col-7 p-2">
                            ...
                            <div class="col-2 text-center align-self-center">
                                <a href="{{ route('admin.course.detail', $new->id) }}"
                    ...
                    <div class="card  my-1" style="height: 120px">
                        <div class="row bg-info-subtle text-emphasis-info g-0">
                            ...
                            <div class="col-2 align-self-center">
                                ...
                                <a href="{{ route('admin.course.public', $new->id) }}"
    ...
    @if (count($courses) > 0)
        ...
        <div class="mx-5 my-3 text-center">
            <form class="input-group">
                ...
                <button type="button" class=" btn btn-secondary input-group-text"> <i
                ...
                <tbody>
                    @foreach ($courses as $course)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.course.unpublic', $course->id) }}" type="button"
                                    class="btn btn-outline-warning"
                                    onclick="return confirm('Are you sure, block this course?')">
                                    <i class="fa-solid fa-shield-halved"></i>
                                </a>

                                <a href="{{ route('admin.course.detail', $course->id) }}" type="button"
