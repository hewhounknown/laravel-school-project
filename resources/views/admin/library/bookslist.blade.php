...
@section('content')
    ...
    <div class="mx-5 my-3 text-center">
        <form class="input-group shadow">
            ...
            <button type="button" class=" btn btn-primary input-group-text"> <i class="fa-solid fa-magnifying-glass"></i>
            </button>
        </form>
    </div>
                    ...
                    <div class="view overlay">
                        @if ($book->cover == null)
                            <img class="card-img-top" src="{{ asset('img/default.png') }}" style="height: 120px"
                                alt="Card image cap">
                        @else
                            <img class="card-img-top" src="{{ asset('storage/library/cover/' . $book->cover) }}"
