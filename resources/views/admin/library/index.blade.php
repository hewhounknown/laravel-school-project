        ...
        @if (count($newbooks) > 0)
            <div id="productCarousel" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="col-3 m-2">
                                        <a href="" class="btn" data-bs-toggle="modal"
                                            ...
                                            <div class="card mb-2" style="height: 210px;">
                                                ...
                                                @else
                                                    <img src="{{ asset('storage/library/cover/' . $new->cover) }}"
                                                        class="card-img-top" style="height: 120px;" alt="...">
                                                @endif
                                                <div class="card-body">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">New book to the
                                                            library</h1>
                                                    ...
                                                    <div class="modal-body row">
                                                        <div class="col-5">
                                                            ...
                                                            @else
                                                                <img src="{{ asset('storage/library/cover/' . $new->cover) }}"
                                                                    class="card-img-top" style="height: 120px; width: auto"
                                                                    alt="...">
                                                            @endif
                                                        </div>
                                                        <div class="col-7">
                                                            ...
                                                            <a href="{{ route('admin.book.read', $new->id) }}"
                                                                class="text-primary">read book here>>></a>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Close</button>
                                                        <a href="{{ route('book.public', $new->id) }}" type="button"
                ...
                <button class="carousel-control-next" type="button" data-bs-target="#productCarousel" data-bs-slide="next"
                    style="right: 0; margin-right: 0px;">
                    <span class="" aria-hidden="true">
            ...
            <div id="bookCarousel" class="carousel slide position-relative" data-ride="carousel">
                <div class="carousel-inner">
                                        ...
                                        <a href="{{ route('admin.book.read', $book->id) }}"
                                            ...
                                            @if ($book->cover == null)
                                                <img src="{{ asset('img/default.png') }}" class="card-img-top"
                                                    style="height: 120px" alt="...">
                                            @else
                                                <img src="{{ asset('storage/library/cover/' . $book->cover) }}"
                                                    class="card-img-top" style="height: 120px" alt="...">
                                            @endif
                                            <div class="card-body">
                    ...
                    <span class="position-absolute top-0 end-0" style="z-index: 100;">
                        <a href="{{ route('book.list') }}" class="btn fs-5"
                            style="color: #63E6BE; background-color: transparent; border: none; padding: 0; font-size: 24px;">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" action="{{ route('admin.book.add') }}" method="post">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger w-25" data-bs-dismiss="modal"><i
                                        class="fa-solid fa-xmark"></i></button>
                                <button type="submit" class="btn btn-primary w-25"><i class="fa fa-check"
