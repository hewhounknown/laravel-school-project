                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row justify-content-between p-2">
                            <div class="col-4">
                                <button class="btn btn-outline-dark w-100" type="button" data-bs-toggle="dropdown"
                            ...
                            <div class="col-4">
                                @if ($user->account_status == 'active')
                                    <a href="{{ route('admin.user.status', ['id' => $user->id, 'status' => 'suspend']) }}"
                                        type="button" class="btn btn-outline-warning w-100"
                    ...
                    <div class="row bg-info-subtle text-emphasis-info g-0">
                        ...
                        <div class="col-sm-2 col-12 mb-2 text-center align-self-center">
                            ...
                            @if ($course->course_status == true)
                                <a href="{{ route('admin.course.unpublic', $course->id) }}"
                                    class="btn btn-outline-secondary btn-lg">
                                    <i class="fa-regular fa-face-smile"></i>
                                </a>
                            @else
                                <a href="{{ route('admin.course.public', $course->id) }}"
