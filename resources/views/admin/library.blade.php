                  ...
                  <div class="row">
                    @foreach($chunk as $new)
                      <div class="col-md-3 m-2">
                        <div class="card mb-2 position-relative" style="height: 210px;">
                            @if ($new->cover == null)
                          ...
                          <span class="position-absolute top-0 start-100 translate-middle p-2 border border-light rounded-circle" style="width: auto;">
                            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#confirmBook">
                                <i class="fa-solid fa-angles-right fa-xl" style="color: #ff7b00;"></i>
                            </button>
                          </span>
                        </div>
                      </div>
