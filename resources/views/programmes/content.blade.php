                ...
                <div class="modal-content">
                    ...
                    @csrf
                        <div class="modal-body">
                            ...
                            <input id="topicId" type="hidden" name="currentType"  value="{{$topic->id}}">
        ...
        <div class="modal" id="deleteForm"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                  <a href="{{route('content.delete', ['topicId'=> $topic->id, 'contentId' => $content->id])}}"><button type="button" class="btn btn-primary">Confirm</button></a>
                </div>
              </div>
            </div>
        </div>
