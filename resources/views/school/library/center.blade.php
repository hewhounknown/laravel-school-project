        ...
        <div class="row">
            <div class="col-md mt-2">
                <form class="input-group">
                    <input id="search" class="form-control p-3 w-75" type="text"
                        placeholder="What are you looking for..." aria-label="Add your item here...">
                    <button type="button" class="w-25 btn btn-secondary input-group-text"> <i
                ...
                @guest
                    <div class="text-center">
                        <a href="{{ route('login') }}" class="w-100 p-3  btn btn-outline-success rounded">
                            Firstly, You need to login here &nbsp; &nbsp; <i
                                class="fa-solid fa-arrow-right-to-bracket fa-lg"></i>
                        </a>
                    </div>
                @else
                    <div class="text-center">
                        <button class="w-100 p-3  btn btn-outline-info rounded" data-bs-toggle="modal"
                        ...
                        <div class="card" style="max-width: 18rem;">
                            @if ($book->cover == null)
                                <img src="{{ asset('img/default.png') }}" class="card-img-top"
                                    style="width:15rem; height: 10rem" alt="...">
                            @else
                                <img src="{{ asset('storage/library/cover/' . $book->cover) }}" class="card-img-top"
                                    style="width:15rem; height: 10rem" alt="...">
                            @endif
                            <div class="card-body">
